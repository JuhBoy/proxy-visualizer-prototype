...
export class FakeServer {
    ...
    public constructor(startNow: boolean, handle: Function) {
        if (startNow)
            this.sampleBase = { uuid: "123553-AZER1235AEZRT-123EZR23FE2RFZREG", method: "GET", status: 200, host: "www.2befficient.fr", path: "/toto/1?no=yes", size: 2598 };
    ...
    public startHttpServer() {
        const responseObj: any = {
            ...
            'requestBody': [0x6b, 0x65, 0x79, 0x31, 0x3d, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x31, 0x26, 0x6b, 0x65, 0x79, 0x32, 0x3d, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x26, 0x6b, 0x65, 0x79, 0x33, 0x3d, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x33, 0x2d, 0x73, 0x70, 0x61, 0x63, 0x65, 0x26, , 0x6b, 0x65, 0x79, 0x34, 0x3d, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x34],
            'responseBody': [0x7b, 0x20, 0x22, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x3a, 0x20, 0x22, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x22, 0x20, 0x7d, 0x7b, 0x20, 0x22, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x3a, 0x20, 0x22, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x22, 0x20, 0x7d, 0x7b, 0x20, 0x22, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x3a, 0x20, 0x22, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x22, 0x20, 0x7d]
        }
        ...
        const server = Http.createServer((req: any, res: any) => {
            ...
            } else if (url.indexOf('update-state') > -1) {
                res.write(JSON.stringify({
                    header: 'update', content: 'state updated', state: {
                        alive: true,
                        listening: false,
                        file: 'toto.txt',
                        changed: true,
                        settings: { exclusionList: ['wwww.2befficient-beta.fr'], port: 8887, interface: '1', registered: true },
                    }
                }));
            } else {
